...
public class ReservationWorkerTest {

    public static void main(String[] args) {
        SpringApplication.run(ReservationWorkerTest.class, args);
        System.out.println("\nUruchomiono test");
    }
    ...
    public void startProcessAfterStartup() {
        ...
        client.newCreateInstanceCommand()
                .bpmnProcessId("Process_0zzgg16")// ID bpmn
                .latestVersion()
                .variables(variables)
                .send();

        System.out.println("[Proces rezerwacji klienta]\n");
    }
}